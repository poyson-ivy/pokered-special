...
; entries correspond to constants/pokemon_constants.asm
	...
	mon_cry CRY_NIDORAN_M,   136,  248 ; ESPEON
	mon_cry CRY_NIDORAN_M,   136,  128 ; UMBREON
	mon_cry CRY_METAPOD,      32,  320 ; MAGNEZONE
	mon_cry CRY_NIDOQUEEN,   221,  224 ; LEAFEON
	mon_cry CRY_BULBASAUR,     0,  320 ; RHYPERIOR
	mon_cry CRY_VENONAT,     170,  383 ; GLACEON
	mon_cry CRY_VULPIX,        0,  256 ; MAGMORTAR
	mon_cry CRY_RAICHU,      248,  192 ; ELECTIVIRE
	mon_cry CRY_KRABBY,       32,  352 ; LICKILICKY
	mon_cry CRY_FEAROW,      238,  129 ; TANGROWTH
	mon_cry CRY_CLEFAIRY,     60,  129 ; BELLOSSOM
	mon_cry CRY_CLEFAIRY,    119,  144 ; POLITOED
	mon_cry CRY_PSYDUCK,     255,  192 ; SLOWKING
	mon_cry CRY_CHARMANDER,    0,  256 ; STEELIX
	mon_cry CRY_FEAROW,      238,  129 ; SCIZOR
	mon_cry CRY_NIDORAN_M,   255,  383 ; KINGDRA
	mon_cry CRY_METAPOD,       0,  256 ; PORYGON2
	mon_cry CRY_CLEFAIRY,    170,  160 ; BLISSEY
	mon_cry CRY_GROWLITHE,   255,  192 ; PORYGONZ
	mon_cry CRY_VENONAT,     170,  383 ; SYLVEON
	mon_cry CRY_VENONAT,      16,  160 ; CROBAT
	mon_cry CRY_PIDGEY,      104,  224 ; HITMONTOP
