...
FuchsiaCity_Object:
	...
	def_bg_events
	bg_event 19, 19, TEXT_FUCHSIACITY_SIGN1
	...
	bg_event  3, 27, TEXT_FUCHSIACITY_GYM_SIGN
	...
	bg_event 15, 19, TEXT_FUCHSIACITY_LAPRAS_SIGN
	bg_event  7,  7, TEXT_FUCHSIACITY_FOSSIL_SIGN

	def_object_events
	object_event 10, 14, SPRITE_YOUNGSTER, WALK, LEFT_RIGHT, TEXT_FUCHSIACITY_YOUNGSTER1
