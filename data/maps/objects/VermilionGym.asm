...
VermilionGym_Object:
	...
	object_event  6,  9, SPRITE_GENTLEMAN, STAY, RIGHT, TEXT_VERMILIONGYM_GENTLEMAN, OPP_GENTLEMAN, 3
	object_event  3,  9, SPRITE_SUPER_NERD, STAY, LEFT, TEXT_VERMILIONGYM_SUPER_NERD, OPP_ROCKER, 1
	object_event  4,  4, SPRITE_SAILOR, STAY, RIGHT, TEXT_VERMILIONGYM_SAILOR, OPP_SAILOR, 8
