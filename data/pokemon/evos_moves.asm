...
RhydonEvosMoves:
; Evolutions
	db EVOLVE_ITEM, MOON_STONE, 1, RHYPERIOR
	db 0
; Learnset
	db 30, STOMP
	db 35, TAIL_WHIP
...
LickitungEvosMoves:
; Evolutions
	db EVOLVE_ITEM, MOON_STONE, 1, LICKILICKY
	db 0
; Learnset
	db 7, STOMP
	db 15, DISABLE
...
SlowpokeEvosMoves:
; Evolutions
	db EVOLVE_ITEM, SUN_STONE, 1, SLOWKING
...
; Evolutions
	...
	db EVOLVE_ITEM, SUN_STONE, 1, POLITOED
	db 0
; Learnset
	db 16, HYPNOSIS
	db 19, WATER_GUN
